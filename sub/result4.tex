...
\subsection{Maximum values of the monthly mean chlorophyll-a concentration.}
 
Figure \ref{fig:monthly_max}. shows the maximum values of monthly mean chlorophyll-a concentration in the East Sea (Sea of Japan). It shows that the LAC data have higher maximum value in the monthly mean chlorophyll-a concentration compared to the GAC data. The maximum value of the differences between the LAC and GAC data were 80 $\rm mg/m^3$ on June, 2003. The maximum values of the both LAC and the GAC data did not have a temporal tendency.
