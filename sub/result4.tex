...
Figure \ref{fig:monthly_max} shows the maximum values of monthly mean chlorophyll-a concentration in the East Sea. It shows that the LAC data have higher maximum value in the monthly mean chlorophyll-a concentration compared to the GAC data. The maximum value of the differences between the LAC data and GAC data was 80 $\rm mg~m^{-3}$ on June, 2003. The maximum values of both the LAC data and the GAC data did not show a strong relationship with the seasons.
...
\begin{figure}[b!]	
	...
	ymajorgrids = true,
	%nodes near coords,
%	legend style={at={(0.9,-0.095)}, text width=2em},anchor=south,legend columns=-1]
	legend style={text width=2.5em},legend columns=-1]
