...
The East Sea was chosen in order to calculate chlorophyll-a concentration using the ocean color data. The study area is shown in Figure \ref{fig:Map_of_Research_Area} as 34 - 44°N, 127 - 135°E which covers the whole East Sea near Korea. The sea south from Korea and the Yellow Sea has been excluded in the study area are because it is difficult to calculate the chlorophyll-a concentration using the ocean color algorithm due to its shallow depth. 
