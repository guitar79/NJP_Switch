...
\begin{figure}[h]
	...
	\end{tikzpicture}
	%	\end{pgfonlayer}
	\scriptsize\caption{(a) Variation of monthly mean values of chlorophyll-a concentration in 2003 using LAC (blue line) and GAC (red line) and its differences between the LAC and GAC data and (b) the number of pixels with a value over 10 $\rm mg~m^{-3}$.}
	\label{fig:diff_2003}
\end{figure}
