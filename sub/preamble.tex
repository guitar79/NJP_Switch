...
%:                  논문 제목과 저자 이름을 입력하시오
% ----------------------------------------------------------------------
\title{SeaWiFS 해색 자료를 이용한 동해 클로로필-a 농도 분석 : LAC 자료와 GAC 자료의 비교} %한글 제목
\engtitle{Analysis of the chlorophyll-a concentration in the East Sea using SeaWiFS ocean color data : comparison between the LAC data and the GAC data} %영문 제목
...
\degreedate{2017}{7}{20} %논문 승인 날짜 양식
