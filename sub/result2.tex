\subsection{The Monthly-Mean Chlorophyll-a Concentration in the East Sea (Sea of Japan)}
 ...
 Although difference between the two data was less than 0.21 $\rm mg/m^3$ for all months, it was not ignorable. This infers that the effect of spatial resolution on the data has to be considered more deeply.
