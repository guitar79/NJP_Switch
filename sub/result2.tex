\subsection{The Monthly-Mean Chlorophyll-a Concentration in the East Sea (Sea of Japan)}
 
 The GAC and the LAC data have been used to create monthly-mean chlorophyll-a concentration and its difference from 2003 to 2006 as shown in Figure \ref{fig:diff_2003} - Figure \ref{fig:diff_2006}. Both the LAC data and the GAC data had similar tendency, showing peaks on spring (April) and fall (November). The maximum/minimum value of LAC and GAC data was each 1.61 $\rm mg/m^3$ / 0.28 $\rm mg/m^3$, and 1.72 $\rm mg/m^3$ / 0.32 $\rm mg/m^3$. 
 
 The difference between the two data was less than 0.21 $\rm mg/m^3$ for every month, but it was not an ignorable value. This infers that the effect of spatial resolution on the data has to be considered more deeply.
 
 Pixels with a value over 10 $\rm mg/m^3$ is also shown in the Figures. LAC data was found to have more pixels over 10 $\rm mg/m^3$, compared to the GAC data except on April 2003 and July 2006. 
...
\begin{figure}[h]
	...
	\end{tikzpicture}
	%	\end{pgfonlayer}
	\scriptsize\caption{(a) monthly mean values of chlorophyll-a concentration in 2003 using LAC (blue line) and GAC (red line) and its differences between the LAC and GAC data and (b) the number of pixels with a value over 10 ${\rm {mg/m^3}}$.}
	\label{fig:diff_2003}
\end{figure}
...
\begin{figure}[h]
	...
	\end{axis}
	\end{tikzpicture}
	\scriptsize\caption{(a) monthly mean values of chlorophyll-a concentration in 2004 using LAC (blue line) and GAC (red line) and its differences between the LAC and GAC data and (b) the number of pixels with a value over 10 ${\rm {mg/m^3}}$.}
	\label{fig:diff_2004}
\end{figure}
...
\begin{figure}[h]
	...
	\end{axis}
	\end{tikzpicture}
	\scriptsize\caption{(a) monthly mean values of chlorophyll-a concentration in 2005 using LAC (blue line) and GAC (red line) and its differences between the LAC and GAC data and (b) the number of pixels with a value over 10 ${\rm {mg/m^3}}$.}
	\label{fig:diff_2005}
\end{figure}
...
\begin{figure}[h]
	...
	\end{axis}
	\end{tikzpicture}
	\scriptsize\caption{(a) monthly mean values of chlorophyll-a concentration in 2006 using LAC (blue line) and GAC (red line) and its differences between the LAC and GAC data and (b) the number of pixels with a value over 10 ${\rm {mg/m^3}}$.}
	\label{fig:diff_2006}
\end{figure}
