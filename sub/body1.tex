...
\begin{figure}[p]
	\centering
	\includegraphics[width=0.8\linewidth]{../images/monGAC01}\\
	\caption{The monthly-mean chlorophyll-a distribution in the Korean East Sea, LAC. From 2003 to 2006, January to June. The unit of the color bar is $\rm mg/m^3$.}
	\label{fig:monGAC01}
\end{figure}
...
\begin{figure}[p]
	\centering
	\includegraphics[width=0.8\linewidth]{../images/monLAC02}\\
	\caption{The monthly-mean chlorophyll-a distribution in the Korean East Sea, LAC. From 2003 to 2006, January to June. The unit of the color bar is $\rm mg/m^3$.}
	\label{fig:monLAC02}
\end{figure}
...
\begin{figure}[p]
	\centering
	\includegraphics[width=0.8\linewidth]{../images/monGAC02}\\
	\caption{The monthly-mean chlorophyll-a distribution in the Korean East Sea, LAC. From 2003 to 2006, January to June. The unit of the color bar is $\rm mg/m^3$.}
	\label{fig:monGAC02}
\end{figure}
...
\begin{figure}[p]
	\centering
	\includegraphics[width=0.8\linewidth]{../images/monLAC03}\\
	\caption{The monthly-mean chlorophyll-a distribution in the Korean East Sea, LAC. From 2003 to 2006, January to June. The unit of the color bar is $\rm mg/m^3$.}
	\label{fig:monLAC03}
\end{figure}
...
\begin{figure}[p]
	\centering
	\includegraphics[width=0.8\linewidth]{../images/monGAC03}\\
	\caption{The monthly-mean chlorophyll-a distribution in the Korean East Sea, LAC. From 2003 to 2006, January to June. The unit of the color bar is $\rm mg/m^3$.}
	\label{fig:monGAC03}
\end{figure}
